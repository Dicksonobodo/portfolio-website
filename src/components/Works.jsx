      ...
      >
        ...
        <div className="mt-5 flex gap-3">
          <button
            ...
            className="flex-1 border border-white text-white px-4 py-2 rounded-lg text-sm hover:bg-white hover:text-black transition"
          >
            GitHub
          </button>
          ...
          {live_link && (
            <button
              ...
              className="flex-1 bg-white text-black px-4 py-2 rounded-lg text-sm hover:bg-blue-300 transition"
            >
              Live Demo
            </button>
          )}
